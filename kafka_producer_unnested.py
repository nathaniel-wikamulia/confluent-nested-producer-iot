...
original_data = [
    {
        "d": {
            ...
            "temp": [147.479972839355469],
            "ts": "2025-11-17T07:57:48.941438"
        }
    }
]

# iot_data = original_data[0]["d"]
iot_data = [item["d"] for item in original_data]
...
for rec in iot_data:
    ...
    key_record = {"M1kwh": rec["M1kwh"]}  # matches key_schema
